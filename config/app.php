...
return [
    ...
    'random_queries' => ['1000mods', '414Beg', 'A Whisper in the Noise', 'A Winged Victory for the Sullen', 'A$AP Rocky', 'Adebisi Shank', 'Aimee Mann', 'Akvavit', 'Alessandra Celletti', 'Alexis Ffrench',
        'Antennas to Heaven', "Aphrodite's Child", 'Apparat', 'April Shower', 'Aquaplasm', 'Árstíðir', 'Attono', 'Aukai', 'BLITZ', 'BLOND:ISH', 'Balthazar', 'Baltic Nature Sounds', 'Beady Eye',
        ...
        'Glowworm', 'Goonies Never Say Die', 'Graham Nash', 'Hidden Orchestra', 'Hideyuki Hashimoto', 'High Tropics', 'Home', 'I Decided.', 'Indra', 'Ingrid Michaelson',
        ...
        'Kronos Quartet Performs Philip Glass', 'LCD Soundsystem', 'La Femme', 'Lara Di Umbra', 'Lavinia Meijer', 'Lee Fields & The Expressions', 'Les Friction', 'Lévon Minassian',
        'Liam Singer', 'Long Distance Calling', 'Lorde', 'Los Makenzy', 'Loscil', 'Love Death Immortality', 'Love What Survives',
        "Lupe Fiasco's Food & Liquor", 'Lupe Sinsonte', 'M83', 'MIAOU', 'Magic Sword', 'Marika Hackman', 'Mario Batkovic', 'Medi Rela', 'Mega Drive', 'Miami Nights 1984', 'Michelle Gurevich',
        ...
        'Rejjie Snow', 'Relaxing Guru', 'Saltillo', 'Saxon Shore', 'Saycet', 'Scattle', 'Sea Power', 'Sigur Rós', 'Singles 1965-1967', 'Skyyy', 'Smino', 'Smokey Robinson & The Miracles',
        ...
        'The Jungle Is The Only Way Out', 'The London Ensemble', 'The Nature Soundscapes', 'The Six Parts Seven', 'The Sound Of The Rain', 'The Who', 'There Existed an Addiction to Blood', 'Tides From Nebula', 'Tom Caufield', 'Tracey Chattaway',
        ...
        'Goodbye Lenin !', 'If These Trees Could Talk', 'Intergalactic Lovers', 'J. Cole', 'Jarryd James', 'Jim James', 'José González', 'Josef Salvat', 'Kavinsky', 'Kendra Logozar', 'Kevin Morby', 'Kid Cudi', 'Led Zeppelin', 'Lera Lynn',
        ...
        'Kai Straw', 'Kanye West', 'Lambert', 'Lazerhawk', 'Nick Mulvey', 'Samsara Blues Experiment', 'Sophie Hutchings', 'The Doors', 'The Irrepressibles', 'The Rolling Stones', 'X Ambassadors', "We're Dreaming", 'm.A.A.d city (Deluxe)', 'And the Things that Remain',
        ...
        'Andrew Belle', 'Arctic Monkeys', 'Collapse Under The Empire', 'Fink', 'Jaymes Young', 'Jóhann Jóhannsson', 'SOHN', 'Zoë Keating', 'toe', 'Antonio Pinto', 'Greg Haines', 'Greg Maroney', 'Keaton Henson', 'Röyksopp', 'Ben Howard', 'Kendrick Lamar', 'Romantic Works', 'Virtual Mage',
